...
dynamic_pars = {'alpha_0': np.array([[5.16,  3.42,  3.86, 10.41]]), 'alpha_tri': 0.08, 'alpha_pop': 0.90, 'sigma': 0.26}
costs_list = []
encoding = {'ATT': 0,'Sprint': 1, 'TMobile': 2, 'Verizon': 3}
...
alpha = 0.046
beta = 1.98
xi_data = pd.read_csv("xi_data.csv")
xi = np.zeros((M, J))
demands_list = []
