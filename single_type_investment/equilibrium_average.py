...
T = 50
J = 3
agg_data = pd.read_csv("agg_data_average.csv")
dynamic_pars = {'alpha_0': np.array([[5.16,  (5.16+10.41)/2, 10.41]]), 'alpha_tri': 0.08, 'alpha_pop': 0.90, 'sigma': 0.26}
costs_list = []
...
alpha = 0.046
beta = 1.98
xi_data = pd.read_csv("xi_data_average.csv")
xi = np.zeros((M, J))
demands_list = []
